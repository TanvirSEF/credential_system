...
import { getAvatarUploadUrlAction, setAvatarAction } from "@/lib/actions/profile";
...
export function AvatarUpload({
  ...
  async function handleFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      if (presign.error || !presign.uploadUrl || !presign.publicUrl || !presign.storagePath) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <label
        ...
        title="Change avatar"
      >
        <Avatar avatarUrl={avatarUrl} name={name} className="h-24 w-24 text-2xl" />
